...
s2_NSR_compounds=set([c.replace("Plate","") for c in s2.query('Hit_HCT116_6h == "-"  or Hit_HCT116_36h =="-" ')['Compound'].values])
s4_NSR_compounds=set([c.replace("Plate","") for c in s4.query('Hit_HCT116_6h == "-"  or Hit_HCT116_36h =="-" ')['Compound'].values])
s5_NSR_compounds=set([c.replace("Plate","") for c in s5.query('Hit_HCT116_6h == "-"  or Hit_HCT116_36h =="-" ')['Compound'].values])
s6_NSR_compounds=set([c.replace("Plate","") for c in s6.query('Hit_HCT116_6h == "-"  or Hit_HCT116_36h =="-" ')['Compound'].values])
s2_NSW_compounds=set([c.replace("Plate","") for c in s2.query('Hit_HCT116_6h == "+"  or Hit_HCT116_36h =="+" ')['Compound'].values])
s4_NSW_compounds=set([c.replace("Plate","") for c in s4.query('Hit_HCT116_6h == "+"  or Hit_HCT116_36h =="+" ')['Compound'].values])
s5_NSW_compounds=set([c.replace("Plate","") for c in s5.query('Hit_HCT116_6h == "+"  or Hit_HCT116_36h =="+" ')['Compound'].values])
s6_NSW_compounds=set([c.replace("Plate","") for c in s6.query('Hit_HCT116_6h == "+"  or Hit_HCT116_36h =="+" ')['Compound'].values])

print(s2_NSR_compounds)

NSR_cpds=set(s2_NSR_compounds|s4_NSR_compounds|s5_NSR_compounds|s6_NSR_compounds)
NSW_cpds=set(s2_NSW_compounds|s4_NSW_compounds|s5_NSW_compounds|s6_NSW_compounds)
