"""
Generate NSR and NSW compounds for any method across all cell lines

Generate a list of NSR, NSW, NSR but not NSW and NSW but not NSR targets
hitting all cell lines, and detected using any (at least 1) analysis method 
- as given in Sup. tables 2,4,5, and 6.
"""
...
NSR_cpds=set(s2_NSR_compounds_PC3|s4_NSR_compounds_PC3|s5_NSR_compounds_PC3|s6_NSR_compounds_PC3).intersection(
...
NSW_cpds=set(s2_NSW_compounds_PC3|s4_NSW_compounds_PC3|s5_NSW_compounds_PC3|s6_NSW_compounds_PC3).intersection(
